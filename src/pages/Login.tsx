...
const IdentitySidebar: React.FC<{ role: string; step: number }> = ({ role, step }) => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#050505] px-6 py-12 overflow-hidden relative font-sans">
      ...
      <motion.div 
        ...
        className={`w-full relative z-10 transition-all duration-700 ${mode === 'register' && regStep > 1 ? 'max-w-4xl' : 'max-w-xl'}`}
      >
